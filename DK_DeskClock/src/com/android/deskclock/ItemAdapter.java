...
public class ItemAdapter<T extends ItemAdapter.ItemHolder>
    ...
    private final OnItemChangedListener mItemChangedNotifier = new OnItemChangedListener() {
        /*bv zhangjiachu add for alarm style 20200106*/
        @Override
        public void onItemSelectedChanged(ItemHolder<?> holder) {
            LogUtils.d("onItemSelectedChanged+++++");
            if (mOnItemChangedListener != null) {
                mOnItemChangedListener.onItemSelectedChanged(holder);
            }
        }
        /*bv zhangjiachu add for alarm style 20200106*/
        @Override
    ...
    public void onBindViewHolder(ItemViewHolder viewHolder, int position) {
        ...
        if(mIsBvOS){ //bv zhangjimeng 2020/07/06 ,when bind view ,not getproperty every time
            /*bv zhangjiachu add for alarm style start*/
            final ItemViewHolder viewHolderTemp = viewHolder;
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener(){
                ...
                public boolean onLongClick(View v) {
                    if(mOnItemLongClickedListener != null) {
                        mOnItemLongClickedListener.onItemLongClicked(viewHolderTemp, positionTemp);
                    }
                    return true;
                }
            });
    ...
    public static abstract class ItemHolder<T> {
        ...
        public final void notifyItemSelectedChanged() {
            LogUtils.d("notifyItemSelectedChanged+++++");
            for (OnItemChangedListener listener : mOnItemChangedListeners) {
                listener.onItemSelectedChanged(this);
            }
        }
    ...
    public interface OnItemChangedListener {
        ...
        /*bv zhangjiachu add for alarm style 20200106 start*/
        void onItemSelectedChanged(ItemHolder<?> itemHolder);
        /*bv zhangjiachu add for alarm style 20200106 end*/
    }
