...
//bv zhangjiachu modify for default to Tab.ALARMS 20200610 start
import android.os.SystemProperties;

import com.android.deskclock.Utils;
//bv zhangjiachu modify for default to Tab.ALARMS 20200610 end
...
final class TabDAO {
    ...
    static Tab getSelectedTab(SharedPreferences prefs) {
        ...
        final int ordinal;
        if(Utils.isBvOS()){
            ordinal = prefs.getInt(KEY_SELECTED_TAB, Tab.ALARMS.ordinal());
        } else {
            ordinal = prefs.getInt(KEY_SELECTED_TAB, Tab.CLOCKS.ordinal());
        }
        //bv zhangjiachu modify for default to Tab.ALARMS 20200610 end
