...
/*bv zhangjiachua delete for alarm style 20191231 start*/
import com.android.deskclock.LogUtils;
/*bv zhangjiachua delete for alarm style 20191231 end*/
//bv zhangjiachu modify for support NightMode 20200610 start
import android.view.Window;
//bv zhangjiachu modify for support NightMode 20200610 end
...
public final class CitySelectionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView cityTitle = (TextView) findViewById(R.id.bv_toolbar_title);
        cityTitle.setText(getApplicationContext().getString(R.string.add_city_title));
    ...
    private static final class CityAdapter extends BaseAdapter implements View.OnClickListener,
        ...
        public CityAdapter(Context context, SearchMenuItemController searchMenuItemController) {
            ...
            //bv zhangjiachu add || Utils.isBvOS() for bv alarm style 20200803
            if ((TextUtils.getLayoutDirectionFromLocale(locale) == View.LAYOUT_DIRECTION_RTL) || Utils.isBvOS()) {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            final int itemViewType = getItemViewType(position);
            /*bv */
            final boolean showCitiesTitle = getShowCitiesTitle(position);

            switch (itemViewType) {
                case VIEW_TYPE_SELECTED_CITIES_HEADER:
                    if (view == null) {
                        if(Utils.isBvOS()){
                            view = mInflater.inflate(R.layout.bv_city_list_header, parent, false);
                        }else {
                        ...
                        || ThemeUtils.isDarkTheme(mContext)) {
                            TextView headertitle = (TextView) view.findViewById(R.id.selecheadertitle);
                            headertitle.setTextColor(Color.parseColor(mContext.getString(R.string.hct_text_color)));
                        }
                        /*hct-fankou add DeskClock LightTheme 20191113 end*/
                        if(Utils.isBvOS()){
                            /*bv zhangjiachu add for alarm style 20200227 start*/
                            TextView headertitle = (TextView) view.findViewById(R.id.selecheadertitle);
                            headertitle.setText(mContext.getString(R.string.selected_city));
                            headertitle.setTextColor(mContext.getResources().getColor(R.color.hct_Accent_color));
                            /*bv zhangjiachu add for alarm style 20200227 end*/
                        }
                    }
                    return view;
                ...
                case VIEW_TYPE_CITY:
                    ...
                    if (view == null) {
                        if(Utils.isBvOS()){
                            view = mInflater.inflate(R.layout.bv_city_list_item, parent, false);
                        }else {
                        ...
                        final View div;
                        if(Utils.isBvOS()){
                            /*bv zhangjiachua add for alarm style 20191231 start*/
                            timezone = (TextView) view.findViewById(R.id.time_zone);
                            title = (TextView) view.findViewById(R.id.unselected_cities_title);
                            div = view.findViewById(R.id.select_div);
                            /*bv zhangjiachua add for alarm style 20191231 end*/
                            /*bv zhangjiachua modify for alarm style 20191231 start*/
                            view.setTag(new CityItemHolder(index, name, timezone, div, title, time, selected));
                            /*bv zhangjiachua modify for alarm style 20191231 end*/
                        }else {
                    ...
                    if(Utils.isBvOS()){
                        /*bv zhangjiachu modify for alarm style 20191231 start*/
                        holder.timezome.setText(Utils.getGMTHourOffset(timeZone, false));
                        holder.title.setText(mContext.getString(R.string.all_city));
                        if (showCitiesTitle){
                        ...
                        /*bv zhangjiachu modify for alarm style 20191231 end*/
                    }
        ...
        /*bv zhangjiachu add start*/
        private boolean getShowCitiesTitle(int position){
        ...
        private boolean getShowIndex(int position) {
            ...
            LogUtils.d("getShowIndex: position = " + position);
            LogUtils.d("getShowIndex: mOriginalUserSelectionCount = " + mOriginalUserSelectionCount);
        ...
        private static final class CityItemHolder {
            ...
            public CityItemHolder(TextView index, TextView name, TextView timezome, View div, TextView title, TextView time, CheckBox selected) {
			/*bv zhangjiachua add for alarm style 20191231 end*/
                this.index = index;
                this.name = name;
                /*bv zhangjiachua add for alarm style 20191231 start*/
