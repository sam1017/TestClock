...
public class AlarmService extends Service {
    ...
    public static void stopAlarm(Context context, AlarmInstance instance) {
        ...
        //hct-fangkou add for system motion turn alarm silence start
        if(android.os.SystemProperties.getBoolean("persist.sys.lctalarm", false)){
            AlarmSensor.getInstance(context).destroy();
        }
        //hct-fangkou add for system motion turn alarm silence end
    ...
    private void startAlarm(AlarmInstance instance) {
        ...
        //hct-fangkou add for system motion turn alarm silence start
        if(android.os.SystemProperties.getBoolean("persist.sys.lctalarm", false)){
            AlarmSensor.getInstance(this).init();
        }
        //hct-fangkou add for system motion turn alarm silence end
    }
