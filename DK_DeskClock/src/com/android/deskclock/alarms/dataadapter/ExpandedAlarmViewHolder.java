...
public final class ExpandedAlarmViewHolder extends AlarmItemViewHolder {
    ...
    /*hct-fankou add DeskClock LightTheme 20191113 start*/
    public static final int HCT_VIEW_TYPE = R.layout.hct_alarm_time_expanded;
    ...
    private ExpandedAlarmViewHolder(View itemView, boolean hasVibrator) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            if(SystemProperties.getBoolean("sys.hctclock_lighttheme",false)){
                dayButton.setButtonDrawable(new Drawable() {
                    ...
                    public void draw(Canvas canvas) {
                        ...
                        mPaint.setTextSize(dayButton.getHeight()*2/5);
            ...
            //hct-fangkou modify lighttheme weekdaytext color end 20191127
            /*hct-fankou add DeskClock LightTheme 20191113 start*/
            if(SystemProperties.getBoolean("sys.hctclock_lighttheme",false)) {
                dayButton.setBackground(context.getDrawable(R.drawable.hct_toggle_circle));
            }
        ...
        final Drawable labelIcon = Utils.getVectorDrawable(context,
                /*hct-fankou add DeskClock LightTheme 20191113 start*/
                (SystemProperties.getBoolean("sys.hctclock_lighttheme",false) ?
                        R.drawable.hct_ic_label : R.drawable.ic_label));
        editLabel.setCompoundDrawablesRelativeWithIntrinsicBounds(labelIcon, null, null, null);
        final Drawable deleteIcon = Utils.getVectorDrawable(context,
                /*hct-fankou add DeskClock LightTheme 20191113 start*/
                (SystemProperties.getBoolean("sys.hctclock_lighttheme",false) ?
                        R.drawable.hct_ic_delete_small : R.drawable.ic_delete_small));
