...
public class NumberPickerView extends View {
    ...
    // default text size of small item
    private static final int DEFAULT_TEXT_SIZE_SMALL_SP = 12;
    ...
    private int mTextColorSmall = DEFAULT_TEXT_COLOR_NORMAL;
    ...
    private float mTextSizeSmallCenterYOffset = 0f;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.NumberPickerView_npv_TextColorSmall) {
                mTextColorSmall = a.getColor(attr, DEFAULT_TEXT_COLOR_NORMAL);
            ...
            } else if (attr == R.styleable.NumberPickerView_npv_TextSizeSmall) {
                mTextSizeSmall = a.getDimensionPixelSize(attr, sp2px(context, DEFAULT_TEXT_SIZE_SMALL_SP));
    ...
    private void init(Context context) {
        ...
        if (mTextSizeSmall == 0) {
            mTextSizeSmall= sp2px(context, DEFAULT_TEXT_SIZE_SMALL_SP);
        }
    ...
    public void setSmallTextColor(int smallTextColor){
        if (mTextColorSmall == smallTextColor){
            return;
        }
        mTextColorSmall = smallTextColor;
        postInvalidate();
    }
    ...
    private void updateFontAttr() {
        ...
        if (mTextSizeSmall > mItemHeight){
            mTextSizeSmall = mItemHeight;
        }
        ...
        mTextSizeSmallCenterYOffset = getTextCenterYOffset(mPaintText.getFontMetrics());
    ...
    private void drawContent(Canvas canvas) {
        ...
        for (int i = 0; i < mShownCount + 1; i++) {
            ...
            /*if (i == mShownCount / 2) {//this will be picked
                ...
                Log.d("zjctest", "drawContent: mShownCount / 2 fraction = " + fraction + "   i = " + i);
                ...
                textSizeCenterYOffset = getEvaluateSize(1 - fraction, mTextSizeNormalCenterYOffset,
                        mTextSizeSelectedCenterYOffset);
                Log.d("zjctest", "drawContent: mShownCount / 2 + 1 fraction = " + fraction + "   i = " + i);
            }else if (i == 1){
                textColor = mTextColorNormal;
                textSize = getEvaluateSize(fraction, mTextSizeSmall, mTextSizeNormal);
                textSizeCenterYOffset = getEvaluateSize(fraction, mTextSizeSmallCenterYOffset,
                        mTextSizeNormalCenterYOffset);
            }else if (i == mShownCount - 2){
                textColor = mTextColorNormal;
                textSize = getEvaluateSize(1 - fraction, mTextSizeSmall, mTextSizeNormal);
                textSizeCenterYOffset = getEvaluateSize(1 - fraction, mTextSizeSmallCenterYOffset,
                        mTextSizeNormalCenterYOffset);
            } else {
                textColor = mTextColorNormal;
                textSize = mTextSizeSmall;
                textSizeCenterYOffset = mTextSizeNormalCenterYOffset;
            }*/
            fraction = (float) (mItemHeight + mCurrDrawFirstItemY) / mItemHeight;
            //bv zhangjiachu add for bv style typeface 20201021 start
            Typeface typeface = Utils.OPPO_SANS_R;
            //bv zhangjiachu add for bv style typeface 20201021 end
            switch (i){
                case 0:
                    textColor = mTextColorSmall;
                    textSize = mTextSizeSmall;
                    textSizeCenterYOffset = mTextSizeSmallCenterYOffset;
                    break;
                case 1:
                    textColor = getEvaluateColor(fraction, mTextColorSmall, mTextColorNormal);
                    textSize = getEvaluateSize(fraction, mTextSizeSmall, mTextSizeNormal);
                    textSizeCenterYOffset = getEvaluateSize(fraction, mTextSizeSmallCenterYOffset, mTextSizeNormalCenterYOffset);
                    break;
                case 2:
                    textColor = getEvaluateColor(fraction, mTextColorNormal, mTextColorSelected);
                    textSize = getEvaluateSize(fraction, mTextSizeNormal, mTextSizeSelected);
                ...
                case 3:
                    ...
                    break;
                case 4:
                    textColor = getEvaluateColor(1 - fraction, mTextColorSmall, mTextColorNormal);
                    textSize = getEvaluateSize(1 - fraction, mTextSizeSmall, mTextSizeNormal);
                    textSizeCenterYOffset = getEvaluateSize(1- fraction, mTextSizeSmallCenterYOffset, mTextSizeNormalCenterYOffset);
                    break;
                default:
                    textColor = mTextColorSmall;
                    textSize = mTextSizeSmall;
