...
/*bv zhangjiachu add for alarm style 20200114 start*/
import android.widget.ImageButton;
import android.os.SystemProperties;
/*bv zhangjiachu add for alarm style 20200114 end*/
...
public class CircleButtonsLayout extends FrameLayout {
    ...
    /*bv zhangjiachu add for alarm style 20200114 start*/
    private ImageButton mResetAddImageButton;
    /*bv zhangjiachu add for alarm style 20200114 end*/
    ...
    protected void remeasureViews() {
        if (mLabel == null) {
            ...
            if(Utils.isBvOS()){
                /*bv zhangjiachu add for alarm style 20200114 start*/
                //mResetAddImageButton = (ImageButton) findViewById(R.id.reset_add_img);
                /*bv zhangjiachu add for alarm style 20200114 end*/
            }
        }
        ...
        if(Utils.isBvOS()){
            /*bv zhangjiachu add for alarm style 20200114 start*/
            if (mResetAddImageButton != null) {
                final MarginLayoutParams resetAddParams = (MarginLayoutParams) mResetAddImageButton
                        .getLayoutParams();
                LogUtils.d("mResetAddImageButton++++++");
                resetAddParams.bottomMargin = circleDiam / 6;
                if (minBound == frameWidth) {
                    resetAddParams.bottomMargin += (frameHeight - frameWidth) / 2;
                }
