...
public class TimerItem extends LinearLayout {
    ...
    void update(Timer timer) {
        ...
        if (!TextUtils.equals(label, mLabelView.getText())) {
            ...
            /*hct-fankou add DeskClock LightTheme start*/
            if(android.os.SystemProperties.getBoolean("sys.hctclock_lighttheme",false)) {
                mLabelView.setTextColor(
                        Color.parseColor(mLabelView.getContext().getString(R.string.hct_text_color)));
            }
            /*hct-fankou add DeskClock LightTheme start*/
        }
