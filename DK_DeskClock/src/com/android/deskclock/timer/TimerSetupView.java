...
/*bv zhangjiachu modify for alarm style 20191230 start*/
import com.android.deskclock.LogUtils;
/*bv zhangjiachu modify for alarm style 20191230 end*/
...
public class TimerSetupView extends LinearLayout implements View.OnClickListener,
    ...
    public TimerSetupView(Context context, AttributeSet attrs) {
        ...
        /*bv zhangjiachu modify for alarm style 20191230 end*/
        if(Utils.isBvOS()){
            LayoutInflater.from(context).inflate(R.layout.bv_timer_setup_container, this);
        }else {
    ...
    protected void onFinishInflate() {
        ...
        if(Utils.isBvOS()){
            /*bv zhangjiachu add for alarm style 20191230 start*/
            mDividerView.setVisibility(GONE);
            /*bv zhangjiachu add for alarm style 20191230 end*/
        }
        updateTime();
