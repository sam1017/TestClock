...
public class TimerItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //bv zhangjiachu modify for bv os 20210306 start
        //final TimerItem view;
        //view = (TimerItem) inflater.inflate(R.layout.timer_item, container, false);
        final BvTimerItem view;
        view = (BvTimerItem) inflater.inflate(R.layout.bv_timer_item, container, false);
        //bv zhangjiachu modify for bv os 20210306 end
        ...
        if(Utils.isBvOS()){
            ...
            //view.findViewById(R.id.reset_add_img).setOnClickListener(new ResetImgAddListener());
    ...
    boolean updateTime() {
        ...
        final BvTimerItem view = (BvTimerItem) getView();
        //bv zhangjiachu modify for bv os 20210306 end
        if (view != null) {
            final Timer timer = getTimer();
            view.update(timer);
    ...
    /*bv zhangjiachu add for alarm style 20191231 start*/
    private final class ResetImgAddListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            final Timer timer = getTimer();
            if (timer.isPaused()) {
