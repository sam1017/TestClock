...
public final class TimerCircleView extends View {
    ...
    public TimerCircleView(Context context, AttributeSet attrs) {
        ...
        /*hct-fankou add DeskClock LightTheme 20191113 start*/
        if(SystemProperties.getBoolean("sys.hctclock_lighttheme",false) || !ThemeUtils.isDarkTheme(context)){
            mRemainderColor = Color.parseColor(context.getString(R.string.hct_line_color));
        }else {
