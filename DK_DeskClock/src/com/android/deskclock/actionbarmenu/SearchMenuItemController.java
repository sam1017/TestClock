...
public final class SearchMenuItemController implements MenuItemController {
    ...
    public void onCreateOptionsItem(Menu menu) {
        ...
        /*bv zhangjiachu add 20200805*/
        if (Utils.isBvOS()) {
            searchView.setQueryHint(mContext.getResources().getString(R.string.input_city_name_to_search));//bv sunyue add string forbug3190 20201209
        }
        ...
        Log.d("bvtest", "onCreateOptionsItem: mSearchMode = " + mSearchMode);
        if (mSearchMode) {
