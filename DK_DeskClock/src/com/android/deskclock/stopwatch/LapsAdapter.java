...
class LapsAdapter extends RecyclerView.Adapter<LapsAdapter.LapItemHolder> {
    ...
    private static String LRM_SPACE = "\u200E ";
    ...
    public LapItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        int resId = R.layout.lap_view;
        if(Utils.isBvOS()){
            resId = R.layout.bv_lap_view;
        }
        final View v = mInflater.inflate(resId, parent, false /* attachToRoot */);
    ...
    static String formatTime(long maxTime, long time, String separator) {
        ...
        //bv zhangjiachu modify 20200523 start
        if(Utils.isBvOS()) {
            sTimeBuilder.append(separator);
        } else {
            sTimeBuilder.append(decimalSeparator);
        }
        //bv zhangjiachu modify 20200523 end
    ...
    private String formatLapTime(long lapTime, boolean isBinding) {
        //bv zhangjiachu add 20200523 start
        final String addStr = mContext.getResources().getString(R.string.str_lap_number);
        //bv zhangjiachu add 20200523 end
        ...
        if(Utils.isBvOS()){
            formattedTime = formatTime(longestLapTime, lapTime, LRM_SPACE);
        } else {
            formattedTime = formatTime(longestLapTime, lapTime, LRM_SPACE);
        }
 	    //bv zhangjiachu modify 20200523 end
        ...
        //bv zhangjiachu add 20200523 start
        if(Utils.isBvOS()) {
            formattedTime = addStr + formattedTime;
        }
        //bv zhangjiachu add 20200523 end
