...
public final class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bv zhangjiachu add for title 20200727 start
        Utils.initToolBar(this);
        //bv zhangjiachu add for title 20200727 end
    ...
    public static class PrefsFragment extends PreferenceFragmentCompat implements
        ...
        public void onCreatePreferences(Bundle bundle, String rootKey) {
            ...
            //bv zhangjiachu add for bv alarm style 20200727 start
            final SimpleMenuPreference clockStylePref = (SimpleMenuPreference)
                    findPreference(KEY_CLOCK_STYLE);
            clockStylePref.setVisible(false);
            final AlarmVolumePreference alarmVolumePref = (AlarmVolumePreference) findPreference("volume_setting");
            alarmVolumePref.setVisible(false);
            //bv zhangjiachu add for bv alarm style 20200727 end
        ...
        private void refresh() {
            ...
            //bv zhangjiachu add for hidden clockSecondsPref 20200804
            if (Utils.isBvOS()) {
                clockSecondsPref.setVisible(false);
            }
        ...
        private void updateAutoSnoozeSummary(ListPreference listPref, String delay) {
            ...
            if (i == -1) {
                ...
                //modify by wangshuoshuo for monkey crash about NullPointException
                if(getActivity() != null) {
