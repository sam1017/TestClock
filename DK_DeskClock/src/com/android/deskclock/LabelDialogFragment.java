...
public class LabelDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mLabelBox.selectAll();
        //*/ hct.fangkou, 2019-11-05, add for EditText set max length start.
        mLabelBox.setFocusable(true);
        mLabelBox.setFocusableInTouchMode(true);
        mLabelBox.requestFocus();
        /* hct.fangkou, 2019-11-05, add for EditText set max length end. */
        /*bv zhangjiachu add for bv os start*/
        mLabelBox.setBackground(context.getDrawable(R.drawable.bv_dialog_edit_background));
        mLabelBox.setTextCursorDrawable(R.drawable.cursor);
        final int editPadding = context.getResources().getDimensionPixelSize(R.dimen.bv_edit_padding);
        mLabelBox.setPadding(editPadding, 0, editPadding, 0);
        mLabelBox.setMinHeight(context.getResources().getDimensionPixelSize(R.dimen.bv_edit_minheight));
        /*bv zhangjiachu add for bv os end*/
